...
<div class="max-w-2xl mx-auto p-4 space-y-4">
    <Card class="p-6">
        ...
        <div class="space-y-4">
            {#if !selectedImage}
                <input type="file" accept="image/*" on:change={handleImageUpload} class="file:mr-4 file:py-2 file:px-4
                file:border-2 file:border-white file:bg-violet-50 file:text-sm file:font-semibold
                file:bg-violet-50 file:mr-4" />
            {/if}
